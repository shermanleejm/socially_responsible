...
export const LoginSME = () => {
  ...
  const signIn = () => {
    localStorage.setItem('username', companyUEN);
    localStorage.setItem('userType', 'sme');
  };

  return (
    <Grid container direction="column" justify="center" alignItems="center">
      <div style={{ width: '90vw', textAlign: 'center', margin: '40px 0 0 0' }}>
        <Grid
          container
          direction="column"
          spacing={2}
            ...
            >
              <Grid item xs={5}>
                <Link
                  ...
                  to={'/loginSME'}
                >
                  <div style={{ color: '#1E3F66' }}>
                    <ThemeProvider theme={theme}>
                      <Typography noWrap variant="subtitle23">
